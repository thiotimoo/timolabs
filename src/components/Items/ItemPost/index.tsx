...
const ItemPost = (blog: BlogMetadata) => {
    ...
    return (
        <Link
            className="border-2 border-fore dark:border-fore-dark border-opacity-10 dark:border-opacity-10 rounded-xl p-4 hover:shadow-xl bg-surface-adaptive active:bg-neutral-500 transition-all flex flex-wrap items-start hover:dark:shadow-neutral-700 hover:ring-fore hover:dark:ring-fore-dark hover:ring-2 overflow-clip hover:-translate-y-1 gap-4"
            href={`/${blogType}/${slug}`}
        >
